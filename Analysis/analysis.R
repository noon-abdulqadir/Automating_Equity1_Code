...
# setwd("..")
# code_dir <- getwd()
reticulate::use_condaenv('/opt/homebrew/Caskroom/mambaforge/base/envs/study1')
reticulate::use_python('/opt/homebrew/Caskroom/mambaforge/base/envs/study1/bin/python3.8', required = TRUE)
