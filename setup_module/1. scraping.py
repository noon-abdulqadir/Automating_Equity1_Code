...
def get_sbi_sectors_list(
    ...
    df_sectors_all = pd.read_pickle(f'{data_save_dir}Sectors Output from script.pkl')[[('SBI Sector Titles'), ('Gender'), ('Age')]].droplevel('Categories', axis=1)[[('SBI Sector Titles', 'Code'), ('SBI Sector Titles', 'Sector Name'), ('SBI Sector Titles', 'Keywords'), ('Gender', 'Dominant Category'), ('Age', 'Dominant Category')]].droplevel('Variables', axis=1)
    ...
    sbi_sectors_dom_gen = {}
    sbi_sectors_dom_age = {}
    sbi_sectors_keywords_dom = defaultdict(list)
    ...
    for cat_keywords in df_sbi_sectors[['Gender_Dominant_Category', 'Used_Sector_Keywords']].to_dict(orient='split')['data']:
        sbi_sectors_keywords_dom[cat_keywords[0]].extend(cat_keywords[1])
    ...
    if save_enabled is True:
        ...
        with open(f'{data_save_dir}sbi_sectors_keywords_dom.json', 'w', encoding='utf8') as f:
            json.dump(sbi_sectors_keywords_dom, f)

    return sbi_english_keyword_list, sbi_english_keyword_dict, sbi_sectors_dict, sbi_sectors_dict_full, sbi_sectors_dom_gen, sbi_sectors_dom_age, sbi_sectors_keywords_dom, trans_keyword_list
...
def get_sector_df_from_cbs(
    ...
    sbi_english_keyword_list, sbi_english_keyword_dict, sbi_sectors_dict, sbi_sectors_dict_full, sbi_sectors_dom_gen, sbi_sectors_dom_age, sbi_sectors_keywords_dom, trans_keyword_list = get_sbi_sectors_list()
